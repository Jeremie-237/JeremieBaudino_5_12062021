function get(item) // fonction qui renvoit la valeur en objet json
{
    return JSON.parse(localStorage.getItem(item)); // 
}
function store(item , value) //json.stringify transforme la valeur a stocker en chaine de caracteres pour etre compatible avec le format local storage
...
function doesExists(item) // // renvoit true or false en function de l'existence d'une valeur pour la clef dont le nom est stoque dans la variable item
// ex:
